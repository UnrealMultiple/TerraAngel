...
public class StyleEditorWindow : ClientWindow
{
    ...
    {
        GetString("Text"),
        GetString("TextDisabled"),
        GetString("WindowBg"),
        GetString("ChildBg"),
        GetString("PopupBg"),
        GetString("Border"),
        GetString("BorderShadow"),
        GetString("FrameBg"),
        GetString("FrameBgHovered"),
        GetString("FrameBgActive"),
        GetString("TitleBg"),
        GetString("TitleBgActive"),
        GetString("TitleBgCollapsed"),
        GetString("MenuBarBg"),
        GetString("ScrollbarBg"),
        GetString("ScrollbarGrab"),
        GetString("ScrollbarGrabHovered"),
        GetString("ScrollbarGrabActive"),
        GetString("CheckMark"),
        GetString("SliderGrab"),
        GetString("SliderGrabActive"),
        GetString("Button"),
        GetString("ButtonHovered"),
        GetString("ButtonActive"),
        GetString("Header"),
        GetString("HeaderHovered"),
        GetString("HeaderActive"),
        GetString("Separator"),
        GetString("SeparatorHovered"),
        GetString("SeparatorActive"),
        GetString("ResizeGrip"),
        GetString("ResizeGripHovered"),
        GetString("ResizeGripActive"),
        GetString("TabHovered"),
        GetString("Tab"),
        GetString("TabSelected"),
        GetString("TabSelectedOverline"),
        GetString("TabDimmed"),
        GetString("TabDimmedSelected"),
        GetString("TabDimmedSelectedOverline"),
        GetString("DockingPreview"),
        GetString("DockingEmptyBg"),
        GetString("PlotLines"),
        GetString("PlotLinesHovered"),
        GetString("PlotHistogram"),
        GetString("PlotHistogramHovered"),
        GetString("TableHeaderBg"),
        GetString("TableBorderStrong"),
        GetString("TableBorderLight"),
        GetString("TableRowBg"),
        GetString("TableRowBgAlt"),
        GetString("TextLink"),
        GetString("TextSelectedBg"),
        GetString("DragDropTarget"),
        GetString("NavHighlight"),
        GetString("NavWindowingHighlight"),
        GetString("NavWindowingDimBg"),
        GetString("ModalWindowDimBg"),
        GetString("COUNT")
    };
